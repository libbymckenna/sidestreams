...
date: "2024-11-19"
categories: [helper functions, acid base equilibrium, chemdose_ph, solvedose_ph, quiz]
format:
  html:
    toc: true
filters:
...
:::::{.question}
On a scale of 1-14, how extroverted are you? 1 = I'm a solo proton type of gal, 14 = OH! I love a good crowd
<input type="number" id="extroversion" min="1" max="14">
...
function checkAnswer() {
  ...
  if (answer >= 1 && answer <= 5) {
    feedback.innerHTML = "You're a very positive person, but sooo acidic. Time for an alkaline make over! Check out solvedose_alk to figure out how much chemical to add to your life to reach a new alkalinity. New carbonate balance, new you.";
  } else if (answer >= 6 && answer <= 8) {
    feedback.innerHTML = "You have a fairly balanced personality that people love to drink up. Use chemdose_ph to see how adding a new chemical to your life will affect your pH. Be careful - you don't want to throw off your current balance!";
  } else if (answer >= 9 && answer <= 14) {
    feedback.innerHTML = "Ya basic! Let's drop that tone down that personality pH. Use solvedose_ph to find how much chemical is required to move you from a Starbucks regular to a local cafe champion.";
  } else {
...
Note - this is only talking about dosing chemicals into water at water treatment facilities. We are not suggesting you literally add chemicals to your human body or that pH is somehow associated with your personality.
