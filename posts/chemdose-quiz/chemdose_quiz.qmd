...
function checkAnswer() {
  ...
  if (answer >= 1 && answer <= 5) {
    ...
    feedback.innerHTML = "Ya basic! Let's tone down that personality pH. Use solvedose_ph to find how much chemical is required to move you from a Starbucks regular to a local cafe champion.";
  } else {
