...
---
The tidywater package can be installed like any other package on CRAN by simply running
`install.packages("tidywater")`. For more details on the package, please see our public
GitHub repository <a href = "https://github.com/BrownandCaldwell-Public/tidywater"> here</a>. 
